...
/**
 * @class PsicolaController
 * @brief Controlador para el dashboard de Psicola en el módulo INFRASTOCK.
 *
 * Este controlador maneja todas las funcionalidades específicas para Psicola:
 ...
 */
class PsicolaController extends Controller
{
    /**
     * Verifica que el usuario tenga el rol de Psicola.
    ...
    private function verifyRole()
    {
        ...
        if (!in_array('Psicola', $userRoles)) {
            abort(403, 'No tienes permiso para acceder a esta sección. Solo usuarios con rol de Psicola pueden acceder.');
        }
    }

    /**
     * Muestra el dashboard principal de Psicola.
     * @return Renderable
     */
    public function dashboard()
    {
        ...
        return view('infrastock::psicola.dashboard', compact(
            'pendingRequests',
            'approvedRequests', 
            'deliveredRequests',
            'rejectedRequests',
    ...
    public function stock(Request $request)
    {
        ...
        return view('infrastock::psicola.stock', compact(
            'equipments',
            'categories',
            'totalEquipment',
            'totalStock',
    ...
    /**
     * Helper: Excluye categorías de aseo para Psicola.
     * Psicola puede solicitar herramientas e insumos generales, NO de aseo.
     * 
    ...
    public function storeRequest(Request $request)
    {
        ...
        try {
            ...
            // Crear notificación para Psicola
            Notification::create([
    ...
    public function myRequests(Request $request)
    {
        ...
        return view('infrastock::psicola.my-requests', compact('requests', 'equipments', 'productiveUnitWarehouses'));
    }
    ...
    public function showRequest($id)
    {
        ...
        return view('infrastock::psicola.show-request', compact('request'));
    }
    ...
    public function notifications()
    {
        ...
        return view('infrastock::psicola.notifications', compact('notifications', 'requests'));
    }
    ...
    public function profile()
    {
        $this->verifyRole();
        $user = auth()->user();
        return view('infrastock::psicola.profile', compact('user'));
    }
    ...
    public function surplusReport(Request $request)
    {
        ...
        return view('infrastock::psicola.surplus-report', compact('surpluses', 'deliveredRequests', 'equipments'));
    }
    ...
    public function storeSurplus(Request $request)
    {
        ...
        try {
            ...
            return redirect()->route('infrastock.psicola.surplus-report')
            ...
            foreach ($admins as $admin) {
                Notification::create([
                    ...
                    'data' => [
                        ...
                        'message' => "Psicola ha creado una nueva solicitud con {$totalItems} insumos: {$equipmentList}.",
                        'request_id' => $request->id,
                        'total_items' => $totalItems,
                        'equipment_list' => $equipmentList,
                        'user_name' => $request->user->nickname ?? $request->user->name ?? 'Psicola',
            ...
            foreach ($admins as $admin) {
                Notification::create([
                    ...
                    'data' => [
                        ...
                        'message' => "Psicola ha generado un reporte de sobrantes para {$surplus->equipment->name}.",
                        'surplus_id' => $surplus->id,
                        'equipment_name' => $surplus->equipment->name,
                        'surplus_amount' => $surplus->surplus_amount,
                        'user_name' => auth()->user()->nickname ?? auth()->user()->name ?? 'Psicola',
                        'action_url' => route('infrastock.admin.requests.index'),
                        'created_at' => now()->format('d/m/Y H:i'),
                    ],
                ]);
