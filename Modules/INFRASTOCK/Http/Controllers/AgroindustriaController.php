...
class AgroindustriaController extends Controller
{
    ...
    public function createRequest(Request $request)
    {
        ...
        return redirect()->route('infrastock.agroindustria.requests.index', $queryParams);
    }
    ...
    public function updateProfile(Request $request)
    {
        ...
        try {
            ...
            return redirect()->route('infrastock.agroindustria.profile')
    ...
    public function surplusReport(Request $request)
    {
        ...
        // Obtener herramientas e insumos generales (excluir aseo) - Mantenido si se usa por compatibilidad
        $query = Equipment::with('category')
            ->orderBy('name');
        ...
        private function notifyAdminNewRequest($request)
    {
        try {
            ...
            $userName = $request->user->nickname ?? $request->user->name ?? 'Agroindustria';
