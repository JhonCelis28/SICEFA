 ...
 * @brief Controlador para el dashboard de Vigilancia en el módulo INFRASTOCK.
 *
 * Este controlador maneja todas las funcionalidades específicas para el personal de Vigilancia:
...
{
    /**
     * Verifica que el usuario tenga el rol de Vigilancia.
    ...
    private function verifyRole()
    {
        ...
        if (!in_array('Vigilancia', $userRoles)) {
            abort(403, 'No tienes permiso para acceder a esta sección. Solo usuarios con rol de Vigilancia pueden acceder.');
        }
    }

    /**
     * Muestra el dashboard principal del personal de Vigilancia.
     * @return Renderable
     */
    public function dashboard()
    {
        ...
        return view('infrastock::Vigilancia.dashboard', compact(
            'pendingRequests',
            'approvedRequests', 
            'deliveredRequests',
            'rejectedRequests',
    ...
    public function stock(Request $request)
    {
        ...
        return view('infrastock::Vigilancia.stock', compact(
            'equipments',
            'categories',
            'totalEquipment',
            'totalStock',
    ...
    /**
     * Helper: Excluye categorías de aseo para Vigilancia.
     * Vigilancia puede solicitar herramientas e insumos generales, NO de aseo.
     * 
    ...
    public function createRequest(Request $request)
    {
        ...
        // Si no es AJAX, redirigir a la página de solicitudes donde está el modal, conservando parámetros (ej. equipment)
        $queryParams = array_merge($request->query(), ['open_modal' => 1]);
        return redirect()->route('infrastock.vigilancia.requests.index', $queryParams);
    }
    ...
    public function storeRequest(Request $request)
    {
        ...
        try {
            ...
            // Crear notificación para Vigilancia
            Notification::create([
    ...
    public function myRequests(Request $request)
    {
        ...
        return view('infrastock::Vigilancia.my-requests', compact('requests', 'equipments', 'productiveUnitWarehouses'));
    }
    ...
    public function showRequest($id)
    {
        ...
        return view('infrastock::Vigilancia.show-request', compact('request'));
    }
    ...
    public function notifications()
    {
        ...
        return view('infrastock::Vigilancia.notifications', compact('notifications', 'requests'));
    }
    ...
    public function profile()
    {
        $this->verifyRole();
        $user = auth()->user();
        return view('infrastock::Vigilancia.profile', compact('user'));
    }
    ...
    public function updateProfile(Request $request)
    {
        ...
        try {
            ...
            return redirect()->route('infrastock.vigilancia.profile')
    ...
    public function surplusReport(Request $request)
    {
        ...
        return view('infrastock::Vigilancia.surplus-report', compact('surpluses', 'deliveredRequests', 'equipments'));
    }
            ...
            foreach ($admins as $admin) {
                Notification::create([
                    ...
                    'data' => [
                        ...
                        'message' => "Vigilancia ha creado una nueva solicitud con {$totalItems} insumos: {$equipmentList}.",
            ...
            foreach ($admins as $admin) {
                Notification::create([
                    ...
                    'data' => [
                        ...
                        'message' => "Vigilancia ha generado un reporte de sobrantes para {$surplus->equipment->name}.",
