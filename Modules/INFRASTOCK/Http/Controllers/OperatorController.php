 ...
 * @brief Controlador para el dashboard de Operario en el módulo INFRASTOCK.
 *
 * Este controlador maneja todas las funcionalidades específicas para el operario:
...
class OperatorController extends Controller
{
    ...
    /**
     * Muestra el dashboard principal del operario.
     * @return Renderable
     */
    public function dashboard()
    {
        ...
        return view('infrastock::operator.dashboard', compact(
            'pendingRequests',
            'approvedRequests', 
            'deliveredRequests',
            'rejectedRequests',
    ...
    public function stock(Request $request)
    {
        ...
        // Filtrar: excluir categorías de aseo para operario (herramientas e insumos generales)
        ...
        return view('infrastock::operator.stock', compact(
            'equipments',
            'categories',
            'totalEquipment',
            'totalStock',
    ...
    /**
     * Helper: Excluye categorías de aseo para el operario.
     * El operario puede solicitar herramientas e insumos generales, NO de aseo.
     * 
    ...
    public function createRequest(Request $request)
    {
        ...
        return redirect()->route('infrastock.operator.requests.index', $queryParams);
    }
    ...
    public function storeRequest(Request $request)
    {
        ...
        try {
            ...
            // Crear notificación para el operario
            Notification::create([
            ...
            return redirect()->route('infrastock.operator.requests.index')
    ...
    public function myRequests(Request $request)
    {
        ...
        return view('infrastock::operator.my-requests', compact('requests', 'equipments', 'productiveUnitWarehouses'));
    }
    ...
    public function showRequest($id)
    {
        ...
        return view('infrastock::operator.show-request', compact('request'));
    }
    ...
    public function notifications()
    {
        ...
        return view('infrastock::operator.notifications', compact('notifications', 'requests'));
    }
    ...
    public function profile()
    {
        $this->verifyRole();
        $user = auth()->user();
        return view('infrastock::operator.profile', compact('user'));
    }
    ...
    public function updateProfile(Request $request)
    {
        ...
        try {
            ...
            return redirect()->route('infrastock.operator.profile')
    ...
    public function surplusReport(Request $request)
    {
        ...
        // Obtener herramientas e insumos generales (excluir aseo) - Para compatibilidad si se usa
        $query = Equipment::with('category')
            ->where(function($q) {
                $q->whereNull('expiration_date')
                  ->orWhere('expiration_date', '>=', now()->startOfDay());
        ...
        return view('infrastock::operator.surplus-report', compact('surpluses', 'deliveredRequests', 'equipments'));
    }
    ...
    public function storeSurplus(Request $request)
    {
        ...
        // Validar que el equipo no sea de categoría de aseo (aunque el selector ya lo limita)
        ...
        try {
            ...
            return redirect()->route('infrastock.operator.surplus-report')
            ...
            foreach ($admins as $admin) {
                ...
                Notification::create([
                    ...
                    'data' => [
                        ...
                        'message' => "El operario ha creado una nueva solicitud con {$totalItems} insumos: {$equipmentList}.",
            ...
            foreach ($admins as $admin) {
                Notification::create([
                    ...
                    'data' => [
                        ...
                        'message' => "El operario ha generado un reporte de sobrantes para {$surplus->equipment->name}.",
