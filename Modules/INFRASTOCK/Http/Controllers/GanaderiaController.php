...
class GanaderiaController extends Controller
{
    ...
    public function createRequest(Request $request)
    {
        ...
        return redirect()->route('infrastock.ganaderia.requests.index', $queryParams);
    }
    ...
    public function updateProfile(Request $request)
    {
        ...
        try {
            ...
            return redirect()->route('infrastock.ganaderia.profile')
            ...
            foreach ($admins as $admin) {
                Notification::create([
                    ...
                    'data' => [
                        ...
                        'message' => "Ganadería ha creado una nueva solicitud con {$totalItems} insumos: {$equipmentList}.",
