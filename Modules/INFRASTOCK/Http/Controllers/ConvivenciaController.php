 ...
 * @brief Controlador para el dashboard de Centro de Convivencia en el módulo INFRASTOCK.
 *
 * Este controlador maneja todas las funcionalidades específicas para el Centro de Convivencia:
...
{
    /**
     * Verifica que el usuario tenga el rol de Centro de Convivencia.
    ...
    private function verifyRole()
    {
        ...
        if (!in_array('Centro de Convivencia', $userRoles)) {
            abort(403, 'No tienes permiso para acceder a esta sección. Solo usuarios con rol de Centro de Convivencia pueden acceder.');
        }
    }

    /**
     * Muestra el dashboard principal del Centro de Convivencia.
     * @return Renderable
     */
    public function dashboard()
    {
        ...
        return view('infrastock::convivencia.dashboard', compact(
            'pendingRequests',
            'approvedRequests', 
            'deliveredRequests',
            'rejectedRequests',
    ...
    public function stock(Request $request)
    {
        ...
        return view('infrastock::convivencia.stock', compact(
            'equipments',
            'categories',
            'totalEquipment',
            'totalStock',
    ...
    /**
     * Helper: Excluye categorías de aseo para el Centro de Convivencia.
     * El Centro de Convivencia puede solicitar herramientas e insumos generales, NO de aseo.
     * 
    ...
    public function storeRequest(Request $request)
    {
        ...
        try {
            ...
            // Crear notificación para el Centro de Convivencia
            Notification::create([
    ...
    public function myRequests(Request $request)
    {
        ...
        return view('infrastock::convivencia.my-requests', compact('requests', 'equipments', 'productiveUnitWarehouses'));
    }
    ...
    public function notifications()
    {
        ...
        return view('infrastock::convivencia.notifications', compact('notifications', 'requests'));
    }
    ...
    public function profile()
    {
        $this->verifyRole();
        $user = auth()->user();
        return view('infrastock::convivencia.profile', compact('user'));
    }
    ...
    public function updateProfile(Request $request)
    {
        ...
        try {
            ...
            return redirect()->route('infrastock.convivencia.profile')
    ...
    public function surplusReport(Request $request)
    {
        ...
        return view('infrastock::convivencia.surplus-report', compact('surpluses', 'deliveredRequests', 'equipments'));
    }
    ...
    public function storeSurplus(Request $request)
    {
        ...
        try {
            ...
            return redirect()->route('infrastock.convivencia.surplus-report')
    ...
    private function notifyAdminNewRequest($request)
    {
        try {
            ...
            $userName = $request->user->nickname ?? $request->user->name ?? 'Centro de Convivencia';
            ...
            foreach ($admins as $admin) {
                ...
                Notification::create([
                    ...
                    'data' => [
                        ...
                        'message' => "El Centro de Convivencia ha creado una nueva solicitud con {$totalItems} insumos: {$equipmentList}.",
            ...
            foreach ($admins as $admin) {
                Notification::create([
                    ...
                    'data' => [
                        ...
                        'message' => "El Centro de Convivencia ha generado un reporte de sobrantes para {$surplus->equipment->name}.",
                        'surplus_id' => $surplus->id,
                        'equipment_name' => $surplus->equipment->name,
                        'surplus_amount' => $surplus->surplus_amount,
                        'user_name' => auth()->user()->nickname ?? auth()->user()->name ?? 'Centro de Convivencia',
                        'action_url' => route('infrastock.admin.supply-requests.index'),
                        'created_at' => now()->format('d/m/Y H:i'),
                    ],
                ]);
