...
<head>
    ...
    <title>@yield('title', 'INFRASTOCK - Ciencias Basicas')</title>
...
<body class="flex h-screen bg-gray-100 font-sans" style="font-family: 'Plus Jakarta Sans', sans-serif;">
    ...
    <div x-data="{
        ...
        <nav class="flex-1 px-2 py-8 space-y-1 custom-scrollbar overflow-y-auto">
            <ul class="space-y-1">
                <!-- Dashboard Principal -->
                <li>
                    <a href="{{ route('infrastock.ciencias-basicas.dashboard') }}" class="sidebar-menu-item font-bold @if(Request::routeIs('infrastock.ciencias-basicas.dashboard')) active @endif">
                ...
                <!-- Stock Disponible -->
                <li>
                    <a href="{{ route('infrastock.ciencias-basicas.stock') }}" class="sidebar-menu-item font-bold @if(Request::routeIs('infrastock.ciencias-basicas.stock')) active @endif">
                ...
                <li>
                    <a href="{{ route('infrastock.ciencias-basicas.requests.index') }}" class="sidebar-menu-item font-bold @if(Request::routeIs('infrastock.ciencias-basicas.requests.*')) active @endif">
                ...
                <!-- Notificaciones -->
                <li>
                    <a href="{{ route('infrastock.ciencias-basicas.notifications') }}" class="sidebar-menu-item font-bold @if(Request::routeIs('infrastock.ciencias-basicas.notifications')) active @endif">
                ...
                <li>
                    <a href="{{ route('infrastock.ciencias-basicas.surplus-report') }}" class="sidebar-menu-item font-bold @if(Request::routeIs('infrastock.ciencias-basicas.surplus-report') || Request::routeIs('infrastock.ciencias-basicas.surplus.*')) active @endif">
    ...
    <div class="flex-1 flex flex-col overflow-hidden">
            ...
            <div class="flex items-center space-x-4">
                ...
                <div x-data="{ dropdownOpen: false, notificationsOpen: false }" class="relative flex items-center space-x-4">
                                ...
                                @if(isset($notifications) && $notifications->count() > 0)
                                    ...
                                    @if($notifications->count() > 5)
                                        <div class="p-4 text-center">
                                            <a href="{{ route('infrastock.ciencias-basicas.notifications') }}" class="text-sm text-green-600 hover:text-green-700 font-medium">
                    ...
                    <div class="relative">
                        <button @click="dropdownOpen = !dropdownOpen" class="flex items-center space-x-2 text-gray-800 hover:text-gray-900 focus:outline-none focus:text-gray-900 p-2 rounded-md hover:bg-gray-100 transition-colors duration-200">
                            ...
                            <div>
                                ...
                                <span class="text-xs text-gray-500 block text-left">Ciencias Basicas</span>
                            </div>
                    ...
                    <div x-show="dropdownOpen" @click.away="dropdownOpen = false" x-cloak class="absolute right-0 mt-2 w-48 bg-white rounded-md shadow-lg py-1 z-50 border border-gray-100">
                        ...
                        <a href="{{ route('infrastock.ciencias-basicas.logout') }}" onclick="event.preventDefault(); document.getElementById('logout-form').submit();" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100"><i class="fas fa-sign-out-alt mr-2 text-red-500"></i> Cerrar Sesión</a>
                        <form id="logout-form" action="{{ route('infrastock.ciencias-basicas.logout') }}" method="POST" class="hidden">
                            @csrf
                        </form>
                    </div>
                </div>
            ...
            <div class="mb-6">
                ...
                <nav class="text-sm font-medium text-gray-500" aria-label="breadcrumb">
                    <ol class="flex items-center space-x-2">
                        ...
                        @if (!Request::routeIs('infrastock.ciencias-basicas.dashboard'))
                        <li class="flex items-center">
                            <a href="{{ route('infrastock.ciencias-basicas.dashboard') }}" class="text-green-600 hover:text-green-800">Dashboard</a>
        ...
        <footer class="bg-white border-t border-gray-200 p-4 text-center text-gray-600 text-sm">
            &copy; {{ date('Y') }} INFRASTOCK - Ciencias Basicas. Todos los derechos reservados.
        </footer>
    ...
    <script>
        ...
        document.getElementById('profileForm').addEventListener('submit', function(e) {
            ...
            fetch('{{ route("infrastock.ciencias-basicas.profile.update") }}', {
                method: 'POST',
                body: formData,
                headers: {
