...
@section('title', 'Detalles de Solicitud - Vigilancia INFRASTOCK')
...
<div class="mb-8">
    <div class="flex justify-between items-center">
        ...
        <a href="{{ route('infrastock.vigilancia.requests.index') }}" class="bg-gray-500 hover:bg-gray-600 text-white px-6 py-2 rounded-md transition-colors duration-200">
