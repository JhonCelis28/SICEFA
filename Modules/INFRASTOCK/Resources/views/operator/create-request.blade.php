<!--
    ...
    * @brief Vista para crear una nueva solicitud de insumo para el Operario.
    *
    * Esta vista presenta un formulario completo para que el operario pueda
...
@section('title', 'Nueva Solicitud - Operario INFRASTOCK')

@section('content')
<!-- Breadcrumb -->
@section('breadcrumb-items')
<li class="flex items-center">
    <a href="{{ route('infrastock.operator.requests.index') }}" class="text-green-600 hover:text-green-800">Mis Solicitudes</a>
...
@endsection
        ...
        <div class="bg-white rounded-xl shadow-md p-8">
            <form action="{{ route('infrastock.operator.requests.store') }}" method="POST" id="requestForm">
                @csrf
                ...
                <div class="flex justify-end space-x-4 pt-6 border-t border-gray-200">
                    <a href="{{ route('infrastock.operator.requests.index') }}" 
