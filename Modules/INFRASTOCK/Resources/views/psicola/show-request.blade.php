...
@section('title', 'Detalles de Solicitud - Psicola INFRASTOCK')

@section('content')
<!-- Breadcrumb -->
@section('breadcrumb-items')
<li class="flex items-center">
    <a href="{{ route('infrastock.psicola.requests.index') }}" class="text-green-600 hover:text-green-800">Mis Solicitudes</a>
...
<div class="mb-8">
    <div class="flex justify-between items-center">
        ...
        <a href="{{ route('infrastock.psicola.requests.index') }}" class="bg-gray-500 hover:bg-gray-600 text-white px-6 py-2 rounded-md transition-colors duration-200">
