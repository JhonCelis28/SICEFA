...
@section('title', 'Mis Solicitudes - PSICOLA INFRASTOCK')

@section('content')
<!-- Breadcrumb -->
@section('breadcrumb-items')
<li class="flex items-center">
    <a href="{{ route('infrastock.psicola.requests.create') }}" class="text-green-600 hover:text-green-800">Nueva Solicitud</a>
        ...
        <div id="request-modal" class="fixed inset-0 bg-gray-900 bg-opacity-50 flex items-center justify-center p-4 hidden z-50">
            <div class="bg-white rounded-lg shadow-xl w-full max-w-4xl max-h-[90vh] overflow-hidden">
                ...
                <div class="p-6 overflow-y-auto max-h-[70vh]">
                    <form id="request-form" action="{{ route('infrastock.psicola.requests.store') }}" method="POST">
                        @csrf
