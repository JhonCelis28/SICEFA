...
@section('title', 'Stock Disponible - Ciencias Basicas INFRASTOCK')
...
<div class="bg-white rounded-xl shadow-md p-6 mb-6">
    <form method="GET" action="{{ route('infrastock.ciencias-basicas.stock') }}" class="grid grid-cols-1 md:grid-cols-4 gap-4">
        <div>
        ...
        <div class="flex items-end space-x-2">
            ...
            <a href="{{ route('infrastock.ciencias-basicas.stock') }}" class="bg-gray-500 hover:bg-gray-600 text-white px-6 py-2 rounded-md transition-colors duration-200">
...
<div class="bg-white rounded-xl shadow-md p-6">
    ...
    @else
        <div class="text-center py-12">
            ...
            <a href="{{ route('infrastock.ciencias-basicas.stock') }}" class="inline-flex items-center px-4 py-2 bg-green-500 text-white rounded-md hover:bg-green-600 transition-colors duration-200">
...
<script>
    function showEquipmentDetails(equipmentId) {
        fetch(`{{ route('infrastock.ciencias-basicas.equipment.show', '') }}/${equipmentId}`)
                ...
                content.innerHTML = `
                    <div class="space-y-4">
                        ...
                        <div class="flex justify-end space-x-3 pt-4 border-t">
                            <a href="{{ route('infrastock.ciencias-basicas.requests.create') }}?equipment=${equipmentId}" class="bg-green-500 hover:bg-green-600 text-white px-6 py-2 rounded-md transition-colors duration-200">
