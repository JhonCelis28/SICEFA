        ...
        <div class="lg:col-span-7">
            <div class="bg-white rounded-xl shadow-md p-6">
                <div class="flex justify-between items-center mb-4">
                    ...
                    <a href="{{ route('infrastock.agroindustria.requests.create') }}" class="px-4 py-2 bg-green-500 text-white rounded-md text-base font-medium hover:bg-green-600 transition-colors duration-200">Nueva Solicitud</a>
                </div>
                <div class="relative">
            ...
            <div class="bg-white rounded-xl shadow-md p-6">
                <div class="flex justify-between items-center mb-4">
                    ...
                    <div class="flex space-x-3">
                        <a href="{{ route('infrastock.agroindustria.notifications') }}" class="text-gray-500 hover:text-green-600 transition-colors duration-200 p-2 rounded-md hover:bg-gray-100"><i class="fas fa-bell text-base"></i></a>
                        <a href="{{ route('infrastock.agroindustria.notifications') }}" class="text-gray-500 hover:text-green-600 transition-colors duration-200 p-2 rounded-md hover:bg-gray-100"><i class="fas fa-bars text-base"></i></a>
                    </div>
                </div>
                ...
                @if(($notifications ?? collect())->count() > 5)
                    <div class="mt-4 text-center">
                        <a href="{{ route('infrastock.agroindustria.notifications') }}" class="text-green-600 hover:text-green-700 font-medium text-sm">
