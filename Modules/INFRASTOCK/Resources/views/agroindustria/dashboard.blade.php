<!--
    ...
    * @brief Vista del dashboard principal para el Agroindustria en el módulo INFRASTOCK.
    *
    * Esta vista presenta un resumen interactivo y en tiempo real de las funcionalidades
    * específicas para el Agroindustria, incluyendo estadísticas de solicitudes,
...
@section('content')
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-6">
        ...
        <div class="bg-white rounded-xl shadow-md p-6 flex items-center justify-between transition-transform transform hover:scale-105 duration-200 relative">
            ...
            <a href="{{ route('infrastock.agroindustria.requests.index') }}?status=pending" class="absolute bottom-0 left-0 right-0 bg-yellow-100 text-yellow-700 text-center px-4 py-2 rounded-b-xl text-sm font-medium hover:brightness-95 transition-all duration-200">Ver Pendientes <i class="fas fa-arrow-circle-right ml-1"></i></a>
        </div>
        ...
        <div class="bg-white rounded-xl shadow-md p-6 flex items-center justify-between transition-transform transform hover:scale-105 duration-200 relative">
            ...
            <a href="{{ route('infrastock.agroindustria.requests.index') }}?status=approved" class="absolute bottom-0 left-0 right-0 bg-green-100 text-green-700 text-center px-4 py-2 rounded-b-xl text-sm font-medium hover:brightness-95 transition-all duration-200">Ver Aprobadas <i class="fas fa-arrow-circle-right ml-1"></i></a>
        </div>
        ...
        <div class="bg-white rounded-xl shadow-md p-6 flex items-center justify-between transition-transform transform hover:scale-105 duration-200 relative">
            ...
            <a href="{{ route('infrastock.agroindustria.requests.index') }}?status=delivered" class="absolute bottom-0 left-0 right-0 bg-blue-100 text-blue-700 text-center px-4 py-2 rounded-b-xl text-sm font-medium hover:brightness-95 transition-all duration-200">Ver Entregadas <i class="fas fa-arrow-circle-right ml-1"></i></a>
        </div>
        ...
        <div class="bg-white rounded-xl shadow-md p-6 flex items-center justify-between transition-transform transform hover:scale-105 duration-200 relative">
            ...
            <a href="{{ route('infrastock.agroindustria.requests.index') }}?status=rejected" class="absolute bottom-0 left-0 right-0 bg-red-100 text-red-700 text-center px-4 py-2 rounded-b-xl text-sm font-medium hover:brightness-95 transition-all duration-200">Ver Rechazadas <i class="fas fa-arrow-circle-right ml-1"></i></a>
        </div>
    </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
        ...
        <div class="bg-white rounded-xl shadow-md p-6">
            ...
            <div class="grid grid-cols-2 gap-4">
                <a href="{{ route('infrastock.agroindustria.requests.create') }}" class="flex flex-col items-center justify-center p-4 bg-green-50 rounded-lg hover:bg-green-100 transition-colors duration-200">
                ...
                <a href="{{ route('infrastock.agroindustria.stock') }}" class="flex flex-col items-center justify-center p-4 bg-blue-50 rounded-lg hover:bg-blue-100 transition-colors duration-200">
                    <i class="fas fa-boxes text-blue-600 text-2xl mb-2"></i>
                    <span class="text-sm font-medium text-gray-700">Ver Stock</span>
                </a>
                <a href="{{ route('infrastock.agroindustria.notifications') }}" class="flex flex-col items-center justify-center p-4 bg-yellow-50 rounded-lg hover:bg-yellow-100 transition-colors duration-200">
                    <i class="fas fa-bell text-yellow-600 text-2xl mb-2"></i>
                    <span class="text-sm font-medium text-gray-700">Notificaciones</span>
                </a>
                <a href="{{ route('infrastock.agroindustria.surplus-report') }}" class="flex flex-col items-center justify-center p-4 bg-orange-50 rounded-lg hover:bg-orange-100 transition-colors duration-200">
        ...
        <div class="bg-white rounded-xl shadow-md p-6">
            <div class="flex items-center justify-between mb-4">
                ...
                <a href="{{ route('infrastock.agroindustria.notifications') }}" class="text-sm text-green-600 hover:text-green-700">Ver todas</a>
            </div>
        ...
        <div class="bg-white rounded-xl shadow-md p-6">
            ...
            @else
                <div class="text-center py-12 bg-gray-50 rounded-lg">
                    ...
                    <a href="{{ route('infrastock.agroindustria.requests.create') }}" class="inline-flex items-center px-4 py-2 bg-green-500 text-white rounded-md hover:bg-green-600 transition-colors duration-200">
