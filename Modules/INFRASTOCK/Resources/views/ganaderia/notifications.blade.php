...
@section('title', 'Notificaciones - Ganadería INFRASTOCK')
...
<div class="bg-white rounded-xl shadow-md overflow-hidden">
                            ...
                            @if($request)
                                ...
                                <div class="mt-4 bg-gray-50 rounded-lg p-4 border border-gray-200">
                                    ...
                                    <div class="flex justify-end mt-4">
                                        <a href="{{ route('infrastock.ganaderia.requests.show', $request->id) }}" 
    ...
    @else
        <div class="text-center py-12">
            ...
            <a href="{{ route('infrastock.ganaderia.requests.index') }}?open_modal=1" class="inline-flex items-center px-4 py-2 bg-green-500 text-white rounded-md hover:bg-green-600 transition-colors duration-200">
