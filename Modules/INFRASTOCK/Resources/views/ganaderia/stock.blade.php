<!--
    ...
    * @brief Vista para visualizar el stock disponible en tiempo real para el Ganadería.
    *
...
@section('title', 'Stock Disponible - Ganadería INFRASTOCK')
...
<div class="bg-white rounded-xl shadow-md p-6 mb-6">
    <form method="GET" action="{{ route('infrastock.ganaderia.stock') }}" class="grid grid-cols-1 md:grid-cols-4 gap-4">
        <div>
        ...
        <div class="flex items-end space-x-2">
            ...
            <a href="{{ route('infrastock.ganaderia.stock') }}" class="bg-gray-500 hover:bg-gray-600 text-white px-6 py-2 rounded-md transition-colors duration-200">
...
<div class="bg-white rounded-xl shadow-md p-6">
    ...
    @else
        <div class="text-center py-12">
            ...
            <a href="{{ route('infrastock.ganaderia.stock') }}" class="inline-flex items-center px-4 py-2 bg-green-500 text-white rounded-md hover:bg-green-600 transition-colors duration-200">
...
<script>
    function showEquipmentDetails(equipmentId) {
        fetch(`{{ route('infrastock.ganaderia.equipment.show', '') }}/${equipmentId}`)
                ...
                content.innerHTML = `
                    <div class="space-y-4">
                        ...
                        <div class="flex justify-end space-x-3 pt-4 border-t">
                            <a href="{{ route('infrastock.ganaderia.requests.create') }}?equipment=${equipmentId}" class="bg-green-500 hover:bg-green-600 text-white px-6 py-2 rounded-md transition-colors duration-200">
